        ...
        <Card>
            <CardContent className="p-3">
                <div className="flex gap-4 items-center">
                    <div className="relative min-h-[110px] min-w-[110px] max-h-[110px] maxw-[110px]">
                        <Image className="rounded-lg" src={service.imageUrl} fill style={{ objectFit: "contain" }} draggable={false} alt={service.name} />
                    </div>
                            ...
                            <Sheet open={sheetIsOpen} onOpenChange={setSheetIsOpen}>
                                ...
                                <SheetContent className="p-0">
                                        ...
                                        <div className="py-6 px-5 border-t border-solid border-secondary flex overflow-x-auto [&::-webkit-scrollbar]:hidden gap-3">
                                            {timeList.map((time) => (
                                                <Button key={time}
                                                    ...
                                                    className="rounded-full" onClick={() => handleHourClick(time)}>
                                                    {time}
                                                </Button>
                                            ))}
                                        </div>
                                    ...
                                    <SheetFooter className="px-5">
                                        <Button disabled={(
                                            !hour || !date
                                        ) || submitIsLoading} onClick={handleBookingSubmit}>
                                            {submitIsLoading && <Loader className="mr-2 h-4 w-4 animate-spin" />}
                                            Confirmar Reserva
                                        </Button>
                                    </SheetFooter>
